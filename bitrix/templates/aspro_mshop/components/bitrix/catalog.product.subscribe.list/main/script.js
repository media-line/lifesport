		...
		if(typeof arBasketAspro !=="undefined"){
			...
			if(typeof window.frameCacheVars !== "undefined"){
				BX.addCustomEvent("onFrameDataReceived", function(){
					window.JCCatalogProductSubscribeList.prototype.setActualDataBlock(th, obj);
				});
			}
		}
	}
...
/*set blocks start*/
window.JCCatalogProductSubscribeList.prototype.setActualDataBlock = function(th, obj)
{
	/*like block start*/
...
/*set compare/wish*/
window.JCCatalogProductSubscribeList.prototype.setLikeBlock = function(th, className, obj, type)
{
	var block=th;
	if(type=="DELAY"){
		if(obj.CAN_BUY){
...
/*set buy*/
window.JCCatalogProductSubscribeList.prototype.setBuyBlock = function(th, obj)
{
...
window.JCCatalogProductSubscribeList.prototype.setPrice = function(price, measure)
{
	var strPrice,
		obData;
...
/*set store quantity*/
window.JCCatalogProductSubscribeList.prototype.setQuantityStore = function(quantity, text)
{
